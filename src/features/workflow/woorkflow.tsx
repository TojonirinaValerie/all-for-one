...
const Workflow = () => {
  return (
    <Section className="lg:px-0 px-0 sm:px-0 md:px-0 py-[80px] max-lg:px-0 min-h-screen bg-white">
      <div className="lg:px-[100px] px-[20px] sm:px-[20px] md:px-[20px] py-[80px] h-[max-content] flex flex-row items-center bg-[#F5F7F9] my-[250px] max-md:flex-col">
        ...
        <div className="lg:relative flex-1">
          <div className="flex flex-col items-end justify-center gap-16 lg:absolute right-0 top-[-330px]">
