...
export default function TechnologiaSection() {
  return (
    <section
      className="bg-[url(/assets/techno/bg-techno.webp)] w-full h-[100%] sm:h-auto md:h-auto bg-no-repeat bg-cover bg-fixed flex flex-row justify-center items-center"
      id="technologie"
    >
      <motion.div
