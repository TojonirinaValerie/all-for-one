...
export function ContactBlock(){
    return <div className="h-[550px] w-[630px] rounded-4xl border p-7 flex flex-col gap-6">
        ...
        <div className="text-sm font-light text-primary flex flex-col flex-1 gap-2 ">
            ...
            <Textarea placeholder="Write your Message here..." className="h-32 rounded-3xl p-4" />
        </div>
